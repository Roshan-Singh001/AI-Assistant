...
import { Shield, ArrowLeft, RefreshCw, User, LogIn } from 'lucide-react';

export default function AccessDenied() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen flex items-center justify-center p-4 transition-all duration-300 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-black">
      <div className="max-w-md w-full text-center transition-all duration-300 text-gray-800 dark:text-white">
        ...
        <div className="p-8 rounded-2xl backdrop-blur-sm border transition-all duration-300 bg-white/80 border-white/20 shadow-2xl shadow-black/10 dark:bg-gray-800/50 dark:border-gray-700/50 dark:shadow-2xl dark:shadow-gray-900/50">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={()=>{navigate("/login")}} className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white shadow-lg shadow-blue-500/30 dark:from-blue-600 dark:to-blue-700 dark:hover:from-blue-500 dark:hover:to-blue-600 dark:shadow-lg dark:shadow-blue-900/50">
              <LogIn className="w-4 h-4" />
              Log in
            </button>
            
            <button onClick={()=>window.location.reload()} className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105 bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 dark:border dark:border-gray-600">
